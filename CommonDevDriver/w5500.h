...
/***************----- W5500 GPIO定义 -----***************/
#define W5500_SCS		GPIO_Pin_1	//定义W5500的CS引脚	 
...
extern unsigned char S1_Port[2];	//端口1的端口号(5000) 
extern unsigned char S1_DIP[4];		//端口1目的IP地址 
extern unsigned char S1_DPort[2];	//端口1目的端口号(6000) 

extern unsigned char S2_Port[2];	//端口2的端口号(5000) 
extern unsigned char S2_DIP[4];	//端口2目的IP地址 
extern unsigned char S2_DPort[2];	//端口2目的端口号(6000) 

extern unsigned char UDP_DIPR[4];	//UDP(广播)模式,目的主机IP地址
extern unsigned char UDP_DPORT[2];	//UDP(广播)模式,目的主机端口号
extern unsigned char UDP1_DPORT[2];	//UDP(广播)模式,目的主机端口号
...
extern unsigned char S1_State;
extern unsigned char S2_State;
#define S_INIT			0x01	//端口完成初始化 
#define S_CONN			0x02	//端口完成连接,可以正常传输数据 

/***************----- 端口收发数据的状态 -----***************/
extern unsigned char S0_Data;		//端口0接收和发送数据的状态,1:端口接收到数据,2:端口发送数据完成 
extern unsigned char S1_Data;
extern unsigned char S2_Data;
#define S_RECEIVE		0x01		//端口接收到一个数据包 
#define S_TRANSMITOK	0x02		//端口发送一个数据包完成 

/***************----- 端口数据缓冲区 -----***************/
extern unsigned char Rx_Buffer[1024];	//端口接收数据缓冲区 
extern unsigned char Tx_Buffer[1024];	//端口发送数据缓冲区 
...
extern unsigned char Detect_Gateway(unsigned char);//检查网关服务器
